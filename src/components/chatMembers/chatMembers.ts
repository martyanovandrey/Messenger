...
class ChatMembers extends Block {
    ...
    componentDidMount() {
        this.setProps({chatMembers: store.state.chatMembers});
    }
    ...
    #headMenu.page-dialog__wrap
        ...
        .page-dialog__pop-up-wrap
            ...
            .page-dialog__pop-up.user-menu(hidden='')
                ...
                .flex_center(class='menuDelete' data-action='menuDelete')
                ...
                .flex_center(class='menuDeleteChat')
                    svg(width='22' height='22' viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg')
            ...
            .page-dialog__pop-up.delete-menu(hidden='')#deleteMenu
                .delete-user
                    ...
                    span.pop-up__margin
                        | Вы уверены ?
                    div
                        button.delete-button(class='deleteChatYes')
                            | Да
                        button.delete-button(class='deleteChatNo')
                            | Нет
