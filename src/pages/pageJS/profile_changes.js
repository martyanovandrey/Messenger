...
document.querySelector("#change_button").addEventListener("click", function (event) {
    event.preventDefault();
    var data = profile_change();
    var profileChangeApiClient = new profile_api_js_1.ProfileChangeAPI();
    profileChangeApiClient.update(data).then(function (data) {
        ...
        console.log(store_js_1.store.state, 'STOREEEESTOREEEESTOREEEESTOREEEE');
