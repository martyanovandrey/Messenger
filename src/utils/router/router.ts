...
class Route {
    ...
    render() {
        ...
        if (location === '/') {
            // @ts-ignore
            import('../../pages/pageJS/login');
        } else if (location === '/signup') {
            // @ts-ignore
            import('../../pages/pageJS/registration');
        } else if (location === '/chat') {
            // @ts-ignore
            import('../../pages/pageJS/chat');
        } else if (location === '/profile') {
            // @ts-ignore
            import('../../pages/pageJS/profile');
        } else if (location === '/profile_changes') {
            // @ts-ignore
            import('../../pages/pageJS/profile_changes');
        } else if (location === '/profile_change_psw') {
            // @ts-ignore
            import('../../pages/pageJS/profile_change_psw');
        }
    }
}
