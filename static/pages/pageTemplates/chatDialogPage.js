export const chatDialogHTML = '';
/*    `
.page-wrap
    .page-sidebar
        .search
            .search__profile-wrap
                a.search__profile(href='../../profile/profile/profile.html') Профиль >
            .search__bar
                svg.search__icon(width='13' height='14' viewBox='0 0 13 14' fill='none' xmlns='http://www.w3.org/2000/svg')
